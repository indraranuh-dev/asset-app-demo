    ...
    buttons: [
        ...
        },
        {
            ...
            action: function ( e, dt, button, config ) {
                window.location = 'https://indraranuh-dev.github.io/asset-app-demo/admin-supplier-tambah.html';
            }
        },
    ]
});
...
$('.show-detail').click(function () {
    ...
    $.getJSON( `https://indraranuh-dev.github.io/asset-app-demo/public/dist/js/pages/r1/suppliers/${_target}.json`, function( data ) {
        const sup = data[0];
