    ...
    buttons: [
        ...
        },
        {
            ...
            action: function ( e, dt, button, config ) {
                window.location = 'https://indraranuh-dev.github.io/asset-app-demo/admin-barang-tambah.html';
            }
        },
    ]
});
...
$('.show-detail').click(function () {
    ...
    $.getJSON( `https://indraranuh-dev.github.io/asset-app-demo/public/dist/js/pages/r1/items/${_target}.json`, function( data ) {
